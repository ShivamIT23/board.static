...
export default function DemoToolbar({
    ...
    return (
        <nav className="w-10 sm:w-12 flex no-scrollbar flex-col items-center bg-sidebar border-r border-border z-30 shrink-0 h-full max-h-screen">
                                        ...
                                        <>
                                            ...
                                            >
                                                <div className="p-1.5 bg-sidebar border border-border rounded-[5px] shadow-2xl">
                                                    <DemoColorPicker color={color} onChange={(hex: string) => setColor(hex)} onSelect={() => setShowColorPicker(false)} />
                                                </div>
                                            </div>
                                        </>,
                                        document.body
