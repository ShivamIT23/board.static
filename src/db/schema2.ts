import { mysqlTable, int, varchar, timestamp, tinyint, datetime } from 'drizzle-orm/mysql-core';
import { relations, sql } from 'drizzle-orm';
import { mysqlEnum } from 'drizzle-orm/mysql-core';

export const authTypeEnum = mysqlEnum("auth_type", ["email", "phone"]);
...
export const users = mysqlTable('users', {
  ...
  authType: authTypeEnum.default('email').notNull(),
...
export const userPackages = mysqlTable('user_packages', {
  ...
  paymentStatus: tinyint('payment_status').default(0),
  // 0 = unpaid, 1 = paid
