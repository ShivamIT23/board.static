...
async function main() {
  ...
  try {
    ...
    await db.insert(schema.features).values([
      ...
      { id: 10, name: 'audio', label: 'Audio', type: 'boolean' },
      { id: 11, name: 'video', label: 'Video', type: 'boolean' },
    ...
    await db.insert(schema.packageFeatures).values([
      ...
      { id: 6, packageId: 1, featureId: 10, value: 'false' },
      { id: 7, packageId: 1, featureId: 11, value: 'false' },
      { id: 8, packageId: 1, featureId: 12, value: 'false' },
      { id: 9, packageId: 2, featureId: 1, value: 'true' },
      { id: 10, packageId: 2, featureId: 2, value: '50' },
      { id: 11, packageId: 2, featureId: 3, value: '20GB' },
      { id: 12, packageId: 2, featureId: 4, value: 'true' },
      { id: 13, packageId: 2, featureId: 5, value: 'true' },
      { id: 14, packageId: 2, featureId: 10, value: 'true' },
      { id: 15, packageId: 2, featureId: 11, value: 'true' },
      { id: 16, packageId: 2, featureId: 12, value: 'true' },
      { id: 17, packageId: 3, featureId: 10, value: 'true' },
      { id: 18, packageId: 3, featureId: 11, value: 'true' },
      { id: 19, packageId: 3, featureId: 12, value: 'true' },
